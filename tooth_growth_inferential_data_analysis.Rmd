...
hypoth2$p.value
```
The confidence interval does not include 0 and the p-value is below the 0.05  threshold. The null hypothesis can be rejected. The alternative hypothesis that 0.5 mg/day dosage of orange juice delivers more tooth growth than ascorbic 
acid is accepted.
...
hypoth3$p.value
```
The confidence interval does not include 0 and the p-value is smaller than the 0.05 threshold. The null hypothesis can be rejected. The alternative hypothesis that 1 mg/day dosage of orange juice delivers more tooth growth than ascorbic 
acid is accepted.
...
Orange juice delivers more tooth growth than ascorbic acid for dosages 0.5 & 1.0. Orange juice and ascorbic acid deliver the same amount of tooth growth for dose amount 2.0 mg/day.  For the entire data set we cannot conclude orange juice is more effective than ascorbic acid.

Assumptions
* Normal distribution of the tooth lengths
* No other unmeasured factors that affect tooth length
